...
SECTIONS = [
    ...
    {
        "id": "leads", "tag": "Speed to lead", "color": "#FF3B30", "title": "Internet leads",
        "intro": "Leads arrive from anywhere, get a reply in seconds, and ring the right rep until someone claims them.",
        "features": [
            ...
            ("Instant first reply with the vehicle photo", "Jessi texts the lead within seconds, matches the vehicle to live inventory and sends the photo along with the first message.",
             "The dealer that replies first usually wins; this replies first every time.", [C, M]),
            ...
            ("Speed-to-lead reporting", "Per-lead badge ('Replied in 4m'), team average response time and a per-rep leaderboard. Only a human reply counts.",
             "Response time becomes a number everyone can see and improve.", [M, O]),
    ...
    },
    {
        ...
        "features": [
            ...
            ("Leaderboards and power rankings", "Individual, store and org rankings on activity, engagement, sales and speed.",
