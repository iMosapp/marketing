    ...
    <div class="nav-links">
      ...
      <div class="nav-item"><button class="nav-trigger">Resources <i class="fa-solid fa-chevron-down chev"></i></button>
        <div class="nav-dd"><div class="nav-dd-inner">
          ...
          <a class="dd-link" href="/developers/"><div class="dd-ico" style="background:rgba(88,86,214,.08)"><i class="fa-solid fa-code" style="color:#5856D6"></i></div><div class="dd-txt"><strong>Developers & API</strong><span>REST API, webhooks, CRM guides</span></div></a>
...
FOOTER_HTML = """<footer>
  <div class="ft-inner">
    ...
    <div class="ft-col"><div class="ft-col-t">Get Started</div><a href="#" onclick="openDemoModal(event,'footer')">Schedule a Demo</a><a href="https://app.imonsocial.com/auth/signup">Start Free Trial</a><a href="https://app.imonsocial.com">Sign In</a><a href="/training">Training</a><a href="/help">Help Center</a><a href="/developers">Developers & API</a></div>
  </div>
