...
NAV_HTML = """<nav>
    ...
    <div class="nav-links">
      <div class="nav-item"><button class="nav-trigger">Products <i class="fa-solid fa-chevron-down chev"></i></button>
        <div class="nav-dd"><div class="nav-dd-inner">
          ...
          <a class="dd-link" href="https://imonsocial.com/digital-card"><div class="dd-ico" style="background:rgba(0,122,255,.08)"><i class="fa-regular fa-id-card" style="color:#007AFF"></i></div><div class="dd-txt"><strong>Digital Cards</strong><span>Shareable, trackable business cards</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/reviews"><div class="dd-ico" style="background:rgba(255,214,10,.1)"><i class="fa-regular fa-star" style="color:#D4AD00"></i></div><div class="dd-txt"><strong>Personal Reviews</strong><span>Portable reputation that follows you</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/showcase"><div class="dd-ico" style="background:rgba(52,199,89,.08)"><i class="fa-solid fa-share-nodes" style="color:#34C759"></i></div><div class="dd-txt"><strong>Link Pages</strong><span>All your socials in one link</span></div></a>
          <div class="nav-dd-label">Engagement</div>
          <a class="dd-link" href="https://imonsocial.com/congrats-template"><div class="dd-ico" style="background:rgba(255,45,85,.08)"><i class="fa-regular fa-image" style="color:#FF2D55"></i></div><div class="dd-txt"><strong>Congrats Cards</strong><span>Celebrate every sale automatically</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/date-triggers"><div class="dd-ico" style="background:rgba(255,149,0,.08)"><i class="fa-solid fa-rocket" style="color:#FF9500"></i></div><div class="dd-txt"><strong>Automated Campaigns</strong><span>Birthdays, follow-ups, on autopilot</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/inbox"><div class="dd-ico" style="background:rgba(88,86,214,.08)"><i class="fa-regular fa-comment-dots" style="color:#5856D6"></i></div><div class="dd-txt"><strong>Inbox & Messaging</strong><span>SMS, email, all in one place</span></div></a>
          <div class="nav-dd-label">Intelligence</div>
          <a class="dd-link" href="https://imonsocial.com/jessi"><div class="dd-ico" style="background:rgba(175,82,222,.08)"><i class="fa-solid fa-wand-magic-sparkles" style="color:#AF52DE"></i></div><div class="dd-txt"><strong>Jessi AI</strong><span>AI-powered relationship insights</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/leaderboard"><div class="dd-ico" style="background:rgba(255,59,48,.08)"><i class="fa-solid fa-trophy" style="color:#FF3B30"></i></div><div class="dd-txt"><strong>Leaderboards</strong><span>Track performance across teams</span></div></a>
        </div></div>
      </div>
      <div class="nav-item"><button class="nav-trigger">Solutions <i class="fa-solid fa-chevron-down chev"></i></button>
        <div class="nav-dd"><div class="nav-dd-inner">
          ...
          <a class="dd-link" href="https://imonsocial.com/organizations"><div class="dd-ico" style="background:rgba(0,122,255,.08)"><i class="fa-solid fa-building" style="color:#007AFF"></i></div><div class="dd-txt"><strong>For Organizations</strong><span>Manage teams, stores & reputation</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/individuals"><div class="dd-ico" style="background:rgba(201,169,98,.08)"><i class="fa-solid fa-user" style="color:#C9A962"></i></div><div class="dd-txt"><strong>For Individuals</strong><span>Own your personal brand</span></div></a>
          <div class="nav-dd-label">By Industry</div>
          <a class="dd-link" href="https://imonsocial.com/salespresentation"><div class="dd-ico" style="background:rgba(52,199,89,.08)"><i class="fa-solid fa-car" style="color:#34C759"></i></div><div class="dd-txt"><strong>Automotive</strong><span>Built for dealerships</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/hub"><div class="dd-ico" style="background:rgba(255,149,0,.08)"><i class="fa-solid fa-briefcase" style="color:#FF9500"></i></div><div class="dd-txt"><strong>Sales Teams</strong><span>Any industry, any size</span></div></a>
        </div></div>
      </div>
      <div class="nav-item"><button class="nav-trigger">Resources <i class="fa-solid fa-chevron-down chev"></i></button>
        <div class="nav-dd"><div class="nav-dd-inner">
          <a class="dd-link" href="https://imonsocial.com/training"><div class="dd-ico" style="background:rgba(0,122,255,.08)"><i class="fa-solid fa-graduation-cap" style="color:#007AFF"></i></div><div class="dd-txt"><strong>Training Hub</strong><span>Courses, videos & best practices</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/help"><div class="dd-ico" style="background:rgba(52,199,89,.08)"><i class="fa-regular fa-circle-question" style="color:#34C759"></i></div><div class="dd-txt"><strong>Help Center</strong><span>Guides, FAQs & support</span></div></a>
          <a class="dd-link" href="https://imonsocial.com/presentation"><div class="dd-ico" style="background:rgba(255,149,0,.08)"><i class="fa-solid fa-play" style="color:#FF9500"></i></div><div class="dd-txt"><strong>Sales Deck</strong><span>See what we can do for you</span></div></a>
        </div></div>
      </div>
      <div class="nav-item"><a href="https://imonsocial.com/pricing">Pricing</a></div>
    </div>
    <div class="nav-cta">
      <a href="https://app.imonsocial.com" class="btn-sign">Sign In</a>
      <a href="https://imonsocial.com/demo" class="btn-demo">Get a Demo</a>
    </div>
  ...
  <div class="mob-menu" id="mob">
    <a href="https://imonsocial.com/digital-card">Digital Cards</a><a href="https://imonsocial.com/reviews">Reviews</a><a href="https://imonsocial.com/inbox">Inbox</a><a href="https://imonsocial.com/organizations">Organizations</a><a href="https://imonsocial.com/pricing">Pricing</a><a href="https://app.imonsocial.com">Sign In</a><a href="https://imonsocial.com/demo" class="mob-cta">Get a Demo</a>
  </div>
</nav>"""
...
FOOTER_HTML = """<footer>
  <div class="ft-inner">
    ...
    <div class="ft-col"><div class="ft-col-t">Product</div><a href="https://imonsocial.com/digital-card">Digital Cards</a><a href="https://imonsocial.com/reviews">Personal Reviews</a><a href="https://imonsocial.com/inbox">Inbox</a><a href="https://imonsocial.com/date-triggers">Automations</a><a href="https://imonsocial.com/leaderboard">Leaderboards</a><a href="https://imonsocial.com/jessi">Jessi AI</a></div>
    <div class="ft-col"><div class="ft-col-t">Company</div><a href="https://imonsocial.com/organizations">For Teams</a><a href="https://imonsocial.com/pricing">Pricing</a><a href="https://imonsocial.com/privacy">Privacy</a><a href="https://imonsocial.com/terms">Terms</a><a href="mailto:forest@imonsocial.com">Contact</a></div>
    <div class="ft-col"><div class="ft-col-t">Get Started</div><a href="https://imonsocial.com/demo">Schedule a Demo</a><a href="https://app.imonsocial.com/auth/signup">Start Free Trial</a><a href="https://app.imonsocial.com">Sign In</a><a href="https://imonsocial.com/training">Training</a><a href="https://imonsocial.com/help">Help Center</a></div>
  </div>
...
<section class="page-hero rv">
  ...
  <div class="hero-btns">
    <a href="https://imonsocial.com/demo" class="btn-lg primary"><i class="fa-regular fa-calendar"></i> Schedule a Demo</a>
...
<section class="cta-bottom">
  ...
  <div class="cta-btns">
    <a href="https://imonsocial.com/demo" class="btn-w"><i class="fa-regular fa-calendar"></i> Schedule a Demo</a>
