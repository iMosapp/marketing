...
NAV_HTML = """<nav>
  <div class="nav-inner">
    ...
    <div class="nav-cta">
      <a href="https://app.imosapp.com" class="btn-sign">Sign In</a>
  ...
  <div class="mob-menu" id="mob">
    <a href="/digital-card">Digital Cards</a><a href="/reviews">Reviews</a><a href="/inbox">Inbox</a><a href="/organizations">Organizations</a><a href="/pricing">Pricing</a><a href="https://app.imosapp.com">Sign In</a><a href="/demo" class="mob-cta">Get a Demo</a>
  </div>
</nav>"""
...
FOOTER_HTML = """<footer>
  <div class="ft-inner">
    ...
    <div class="ft-col"><div class="ft-col-t">Get Started</div><a href="/demo">Schedule a Demo</a><a href="https://app.imosapp.com/auth/signup">Start Free Trial</a><a href="https://app.imosapp.com">Sign In</a><a href="/training">Training</a><a href="/help">Help Center</a></div>
  </div>
...
<section class="page-hero rv">
  ...
  <div class="hero-btns">
    ...
    <a href="https://app.imosapp.com/auth/signup" class="btn-lg ghost">Start Free <i class="fa-solid fa-arrow-right"></i></a>
  </div>
</section>
...
<section class="cta-bottom">
  ...
  <div class="cta-btns">
    ...
    <a href="https://app.imosapp.com/auth/signup" class="btn-gw">Start Free Trial <i class="fa-solid fa-arrow-right"></i></a>
  </div>
</section>
{footer}
<script>
