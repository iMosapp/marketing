...
FOOTER_HTML = """<footer>
  <div class="ft-inner">
    ...
    <div class="ft-col"><div class="ft-col-t">Company</div><a href="/organizations">For Teams</a><a href="/pricing">Pricing</a><a href="/privacy">Privacy Policy</a><a href="/terms">Terms of Service</a><a href="/sms-terms">SMS Policy</a><a href="#" onclick="openDemoModal(event,'footer_contact')">Contact Us</a></div>
...
for slug, data in LEGAL_PAGES.items():
    html = LEGAL_TEMPLATE.format(
        ...
        css=CSS,
        nav=NAV_HTML,
        footer=FOOTER_HTML + DEMO_MODAL_HTML,
    )
    path = f"/app/marketing/build/{slug}/index.html"
    os.makedirs(os.path.dirname(path), exist_ok=True)
    with open(path, "w") as f:
...
# Generate demo page
demo_html = DEMO_PAGE_HTML.format(css=CSS, nav=NAV_HTML, footer=FOOTER_HTML + DEMO_MODAL_HTML)
