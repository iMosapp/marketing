...
async def seed_project_scope(x_user_id: str = Header(None, alias="X-User-ID")):
    ...
    doc = {
        ...
        "summary": "Full scope of the i'M On Social platform: every feature, how it works, what not to touch, technical architecture, and operational guidance. Share this with anyone who needs to understand the system.",
        "category": "operations",
        "icon": "book",
        "sort_order": 0,
        "version": "2.0",
