...
PREBUILT_TEMPLATES = [
    ...
    {
        "id": "cold_outreach_text",
        "name": "Cold Outreach - Text Series",
        "description": "A proven 3-text drip for reaching new prospects. Opens with curiosity, follows up with value, and closes with a respectful breakup that gets the highest response rate.",
        "type": "custom",
        ...
        "sequences": [
            {
                ...
                "channel": "sms",
                "ai_generated": True,
                "step_context": "Day 1 - The Opener. No pitch. Just a genuine, curiosity-driven question about their follow-up process. The goal is to start a conversation, not sell. Keep it short and relatable.",
                "message_template": "Hey {name} - quick question. How does your team stay in touch with customers after they buy? Not selling anything. Just curious because we built something that automates the entire follow-up process after a sale and people keep telling us it's the thing they didn't know they needed.",
                "media_urls": [],
            },
            {
                "step": 2,
                ...
                "channel": "sms",
                "ai_generated": True,
                "step_context": "Day 3 - The One Stat Nudge. Follow up with one painful stat about customer retention. Offer to send a video instead of asking for a call - it's lower commitment. Keep it concise.",
                "message_template": "Hey {name} - following up. Quick stat: the average dealership loses 68% of customers to competitors within 2 years because nobody follows up after the sale. We fix that. Automatically. Takes 30 seconds to see how. Want me to send a quick video?",
                "media_urls": [],
            },
            {
                "step": 3,
                ...
                "channel": "sms",
                "ai_generated": True,
                "step_context": "Day 7 - The Breakup Text. This is the highest-converting message in the series. Be respectful, acknowledge the timing might be off, but leave a link for later. End on a positive note. Breakup texts get the most responses.",
                "message_template": "Last one from me, {name}. If the timing's not right, no worries at all. But if you ever want to see how one photo with a customer can turn into 5 years of automated follow-up - I'm here. Either way, hope you're crushing it over there.",
                "media_urls": [],
            },
        ],
    },
    {
        ...
        "name": "Cold Outreach - Email Series",
        "description": "A 3-email drip for reaching decision-makers. Leads with value, follows with social proof, and closes with a memorable breakup line. Built for GMs, sales managers, and BDC directors.",
        "type": "custom",
        "trigger_tag": "cold_prospect",
        "icon": "mail",
        "color": "#007AFF",
        ...
        "sequences": [
            {
                ...
                "channel": "email",
                "ai_generated": True,
                "step_context": "Day 1 - The Value Lead. Paint the problem vividly - what happens after a customer drives off the lot? Nothing. Then present the 10-second version of the solution. End with a soft ask for 15 minutes.",
                "message_template": "Subject: What happens after 'Congratulations on your new car'?\n\nHi {name},\n\nHere's a question most dealers can't answer: What happens to a customer after they drive off the lot?\n\nFor most dealerships, the answer is... nothing. Maybe a survey. Maybe a service reminder 6 months later. That's it.\n\nMeanwhile, that customer - the one you spent thousands in ad dollars acquiring - goes dark. No follow-up. No relationship. No referral. No repeat business.\n\nWe built i'M On Social to fix that. Here's the 10-second version:\n\nYour salesperson takes a photo with the customer at delivery. From that single moment, the system automatically sends personalized follow-ups for years - birthdays, anniversaries, check-ins, referral requests.\n\nThe customer thinks your team is incredible. Your team barely has to lift a finger.\n\nWorth 15 minutes to see it in action?\n\n{salesperson_name}",
                "media_urls": [],
            },
            {
                "step": 2,
                ...
                "channel": "email",
                "ai_generated": True,
                "step_context": "Day 4 - The Social Proof. Lead with the most common reaction dealers have - 'Why didn't we have this already?' Acknowledge the real problem (CRMs collect dust, spreadsheets get abandoned). Keep the ask soft - just 15 minutes.",
                "message_template": "Subject: \"Why didn't we have this already?\"\n\nHi {name},\n\nThat's the most common thing we hear from dealers after they see i'M On Social.\n\nNot \"this is cool\" (though they say that too).\n\nIt's: \"Why didn't we have this already?\"\n\nBecause every dealership knows follow-up matters. But nobody has time to do it manually. Spreadsheets get abandoned. CRMs collect dust. And customers forget about you.\n\ni'M On Social makes it automatic. Your team keeps selling. The system keeps the relationship alive.\n\nIf you've got 15 minutes this week, I'd love to show you.\n\n{salesperson_name}",
                "media_urls": [],
            },
            {
                "step": 3,
                ...
                "channel": "email",
                "ai_generated": True,
                "step_context": "Day 8 - The Breakup Email. Acknowledge they're busy. Be respectful but leave them with one killer line they'll remember. Include a link to the demo page. End warmly.",
                "message_template": "Subject: Closing the loop\n\nHi {name},\n\nI know you're busy running a dealership, so I'll keep this short.\n\nIf the timing isn't right, I totally understand. But I didn't want to disappear without leaving you with this:\n\nIf your team isn't consistently following up after the sale, you're losing deals you already earned.\n\nWe fix that. Automatically.\n\nWhenever you're ready: imonsocial.com/dealers\n\nWishing you a great month,\n{salesperson_name}",
                "media_urls": [],
            },
        ],
    },
