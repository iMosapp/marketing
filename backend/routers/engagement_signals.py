...
async def get_team_hot_leads(manager_id: str, hours: int = 48):
    ...
    for uid in team_ids:
        ...
        team_stats.append({
            ...
            "texts": event_map.get("sms_sent", 0) + event_map.get("sms_personal", 0) + event_map.get("personal_sms", 0) + event_map.get("sms_failed", 0),
            "emails": event_map.get("email_sent", 0) + event_map.get("email_failed", 0),
