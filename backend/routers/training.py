...
SEED_TRACKS = [
    {
        ...
        "description": "Follow these simple tutorial videos. You will be an expert at creating lifelong relationships in no time!",
        "icon": "play-circle",
        "color": "#FF2D55",
        ...
        "lessons": [
            {
                "slug": "saving-the-app",
                "title": "Saving the App to Your Phone",
                "description": "Get started by saving the app to your phone for easy access.",
                "icon": "download",
                "duration": "1 min",
                "order": 1,
                "content": "## Saving the App to Your Phone\n\nLearn how to save i'M On Social to your phone's home screen so it's always one tap away — just like a native app.",
                "video_url": "https://www.youtube.com/watch?v=NAyOTlR-gf8",
                "steps": ["Watch the video", "Save the app to your home screen", "Open it from your home screen to confirm"],
            },
            {
                "slug": "setting-up-your-profile",
                "title": "Setting Up Your Profile",
                "description": "Configure your profile, photo, and personal brand.",
                "icon": "person-circle",
                "duration": "3 min",
                "order": 2,
                "content": "## Setting Up Your Profile\n\nYour profile is your first impression. Set up your photo, title, bio, and contact info so customers see a polished, professional brand.",
                "video_url": "https://www.youtube.com/watch?v=dT7ybKZembI",
                "steps": ["Watch the video", "Upload a professional headshot", "Fill in your title and bio", "Add your phone number and email"],
            },
            {
                "slug": "home-screen",
                "title": "Home Screen",
                "description": "Navigate the Home screen and understand your daily dashboard.",
                "icon": "home",
                "duration": "3 min",
                "order": 3,
                "content": "## Home Screen\n\nYour Home screen is mission control. See today's touchpoints, quick actions, recent activity, and everything you need to start your day.",
                "video_url": "https://www.youtube.com/watch?v=nsTC9IVEmNY",
                "steps": ["Watch the video", "Review your Home screen", "Try each quick action button", "Check your touchpoints for today"],
            },
            {
                "slug": "contacts-overview",
                "title": "Contacts",
                "description": "Master your contact list — add, search, and manage your customers.",
                "icon": "people",
                "duration": "4 min",
                "order": 4,
                "content": "## Contacts\n\nYour contacts are the heart of the platform. Learn how to add, search, sort, and manage your customer database like a pro.",
                "video_url": "https://www.youtube.com/watch?v=in5K_-TRKlM",
                "steps": ["Watch the video", "Add a new contact", "Search for an existing contact", "Open a contact and explore their profile"],
            },
            {
                "slug": "inbox-overview",
                "title": "Inbox",
                "description": "Send messages, manage conversations, and stay on top of communication.",
                "icon": "mail",
                "duration": "3 min",
                "order": 5,
                "content": "## Inbox\n\nYour Inbox keeps every conversation in one place. Send texts, emails, and review requests — and never lose track of a customer interaction.",
                "video_url": "https://www.youtube.com/watch?v=Dccm4yhkapM",
                "steps": ["Watch the video", "Open the Inbox tab", "Send a test message", "Try using a template"],
            },
            {
                "slug": "best-practices",
                "title": "Best Practices",
                "description": "Tips and strategies to get the most out of the platform.",
                "icon": "trophy",
                "duration": "3 min",
                "order": 6,
                "content": "## Best Practices\n\nLearn the habits and techniques that top-performing users follow to build lasting customer relationships and drive more reviews.",
                "video_url": "https://www.youtube.com/watch?v=KfCXQEzLKTA",
                "steps": ["Watch the video", "Pick 2 practices to start using today", "Set a daily reminder to check your touchpoints", "Send at least 3 personalized messages this week"],
            },
            {
                "slug": "30-second-workflow",
                "title": "The 30 Second Workflow",
                "description": "The fastest way to stay connected with every customer, every day.",
                "icon": "timer",
                "duration": "2 min",
                "order": 7,
                "content": "## The 30 Second Workflow\n\nThis is the secret weapon. In just 30 seconds, you can complete your daily touchpoints and keep every relationship warm. No excuses.",
                "video_url": "https://www.youtube.com/watch?v=5YpvvDChBOY",
                "steps": ["Watch the video", "Practice the 30-second workflow", "Do it every morning for one week", "Track how many touchpoints you complete"],
            },
            {
                "slug": "tags-campaigns-relationships",
                "title": "Tags, Campaigns, and Life Long Relationships",
                "description": "Automate your follow-ups with tags and campaigns.",
                "icon": "pricetags",
                "duration": "3 min",
                "order": 8,
                "content": "## Tags, Campaigns, and Life Long Relationships\n\nTags and campaigns turn one-time buyers into lifelong customers. Learn how to set up automated follow-ups that feel personal, not robotic.",
                "video_url": "https://www.youtube.com/watch?v=Uss8ziGL120",
                "steps": ["Watch the video", "Create a tag for a customer segment", "Explore the campaign builder", "Set up your first automated campaign"],
            },
            {
                "slug": "my-brand-video",
                "title": "My Brand Video",
                "description": "Set up your digital card, link page, and showcase to build your personal brand.",
                "icon": "sparkles",
                "duration": "2 min",
                "order": 9,
                "content": "## My Brand\n\nYour brand is how customers find and remember you. This video covers your Digital Card, Link Page, Landing Page, and Showcase — all your presence assets in one place.",
                "video_url": "https://www.youtube.com/watch?v=zJN4XIYhow4",
                "steps": ["Watch the video", "Set up your Digital Card", "Customize your Link Page", "Share your Showcase link with a customer"],
            },
        ],
    },
    {
