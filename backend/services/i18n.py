...
T = {
    "en": {
        ...
        "pdf.mix": "By channel", "pdf.ch.call": "Calls", "pdf.ch.text": "Text shops", "pdf.ch.email": "Email shops", "pdf.ch.avg": "avg {v}%", "pdf.ch.first": "first reply {d}", "pdf.ch.unanswered": "{n} unanswered", "pdf.ch.none": "no scores yet",
        "pdf.tag.call": "CALL", "pdf.tag.text": "TEXT SHOP", "pdf.tag.email": "EMAIL SHOP", "pdf.thread": "Reply speed: first {first}, slowest {slow}, {n} replies", "pdf.thread_none": "Never replied to the shopper",
        "mail.week.button": "Open the report: calls, texts, emails and coaching",
        ...
        "mail.open_report": "Open the live report", "mail.pdf_attached": "The PDF version is attached. The live report has every shop marked as a call, text shop or email shop: recordings for calls, the full thread with reply times for texts and emails, plus coaching and a history for each person.",
    ...
    "nl": {
        ...
        "pdf.completed": "Shops afgerond", "pdf.of": "{a} van {b}", "pdf.avg": "Gemiddelde score", "pdf.people": "Medewerkers geshopt", "pdf.need": "Training nodig", "pdf.na": "n.v.t.",
        "pdf.mix": "Per kanaal", "pdf.ch.call": "Gesprekken", "pdf.ch.text": "Sms-shops", "pdf.ch.email": "E-mailshops", "pdf.ch.avg": "gem. {v}%", "pdf.ch.first": "eerste reactie {d}", "pdf.ch.unanswered": "{n} onbeantwoord", "pdf.ch.none": "nog geen scores",
        "pdf.tag.call": "GESPREK", "pdf.tag.text": "SMS-SHOP", "pdf.tag.email": "E-MAILSHOP", "pdf.thread": "Reactiesnelheid: eerste {first}, traagste {slow}, {n} reacties", "pdf.thread_none": "Nooit op de shopper gereageerd",
        "mail.week.button": "Open het rapport: gesprekken, sms, e-mail en coaching",
        ...
        "mail.open_report": "Open het live rapport", "mail.pdf_attached": "De pdf zit in de bijlage. In het live rapport staat elke shop gemarkeerd als gesprek, sms-shop of e-mailshop: opnames bij gesprekken, het volledige gesprek met reactietijden bij sms en e-mail, plus coaching en de historie per medewerker.",
