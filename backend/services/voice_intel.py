...
## Respond in EXACTLY this JSON format:
{
  ...
  "purchase_context": "hot buttons: what matters most to them in this purchase or the one they are shopping for (budget, safety, towing, family, image, reliability) and what drove or is driving the decision, or null",
...
FIELD_LABELS = {
    ...
    "vehicle_details": "Vehicle details", "trade_in": "Trade-in", "purchase_context": "Hot buttons",
