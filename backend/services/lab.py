...
FEATURES = [
    ...
    {"key": "jessi_live_voice", "name": "Talk to Jessi (live voice)", "icon": "radio",
     ...
     "how_to_test": ["Open the Voice Lab, pick a voice and energy, tap Audition and just talk: ask who you should talk to today, then ask about one of them by name.",
                     ...
                     "On Home, tap 'Walk me through it' under DO THIS NEXT. Jessi runs the board: replies waiting, overdue touchpoints, your three, then the top hot leads. Say 'draft it', 'done', 'skip' or 'next'; the screen follows and Home ticks items off."],
