...
EVENT_TYPE_LABELS = {
    ...
    # Internet lead pipeline + every outbound touch (see utils/activity_log.py)
    "new_lead": "New Lead Arrived",
    "returning_lead": "Returning Lead",
    "auto_text_sent": "Auto Text Sent",
    "ai_reply_sent": "Jessi Replied",
    "mms_sent": "Photo Sent",
    "lead_call_attempt": "Lead Call Rang You",
    "lead_call_connected": "Connected to Lead",
    "lead_claimed": "Lead Claimed",
    "lead_released": "Lead Released to Queue",
    "outbound_call": "Call Placed",
    "inbound_call": "Inbound Call",
    "call_voicemail": "Left Voicemail",
    "call_no_answer": "No Answer",
    "call_busy": "Line Busy",
    "campaign_step_sent": "Campaign Text Sent",
    "just_tried_text": "Missed-You Text Sent",
}

# event_type -> (icon, color, category) for events written through utils.activity_log
EVENT_META = {
    "new_lead":            ("flash",               "#FF3B30", "lead"),
    "returning_lead":      ("refresh-circle",      "#FF9500", "lead"),
    "lead_claimed":        ("hand-right",          "#34C759", "lead"),
    "lead_reassigned":     ("swap-horizontal",     "#5AC8FA", "lead"),
    "lead_released":       ("arrow-undo",          "#8E8E93", "lead"),
    "lead_call_attempt":   ("call",                "#FF9500", "call"),
    "lead_call_connected": ("call",                "#34C759", "call"),
    "outbound_call":       ("call-outline",        "#30D158", "call"),
    "call_placed":         ("call-outline",        "#30D158", "call"),
    "inbound_call":        ("call",                "#007AFF", "call"),
    "auto_text_sent":      ("chatbubble-ellipses", "#5AC8FA", "sms"),
    "ai_reply_sent":       ("sparkles",            "#AF52DE", "sms"),
    "sms_sent":            ("chatbubble",          "#007AFF", "sms"),
    "personal_sms":        ("chatbubble",          "#007AFF", "sms"),
    "mms_sent":            ("image",               "#007AFF", "sms"),
    "customer_reply":      ("chatbubble-ellipses", "#34C759", "sms"),
    "digital_card_sent":   ("card",                "#007AFF", "share"),
    "vcard_sent":          ("person-circle",       "#007AFF", "share"),
    "vcf_sent":            ("person-circle",       "#007AFF", "share"),
    "review_request_sent": ("star",                "#FFD60A", "share"),
