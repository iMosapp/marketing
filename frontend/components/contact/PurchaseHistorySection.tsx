...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  sectionTitle:  { fontSize: 15, fontWeight: '700', color: colors.textSecondary, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  emptyText:     { fontSize: 14, color: colors.textTertiary, flex: 1 },
  ...
  fieldLabel:    { fontSize: 13, fontWeight: '700', color: colors.textSecondary, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
