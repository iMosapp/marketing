...
const styles = StyleSheet.create({
  ...
  matchName: { fontSize: 18, fontWeight: '600', color: '#FFFFFF' },
  matchDetail: { fontSize: 15, color: '#8E8E93', marginTop: 2 },
  vsRow: {
    flexDirection: 'row',
    alignItems: 'center',
    marginVertical: 12,
  ...
  vsText: { fontSize: 14, color: '#6E6E73', marginHorizontal: 12 },
  providedCard: {
    backgroundColor: '#2C2C2E',
    borderRadius: 10,
    padding: 14,
  ...
  providedName: { fontSize: 18, fontWeight: '600', color: '#FF9500' },
  actions: { gap: 8 },
  actionBtn: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  actionBtnLast: {},
  actionText: { fontSize: 17, color: '#FFFFFF', fontWeight: '500', flex: 1 },
  cancelBtn: {
    marginTop: 12,
    padding: 12,
    alignItems: 'center',
  },
  cancelText: { fontSize: 17, color: '#8E8E93', fontWeight: '500' },
});
