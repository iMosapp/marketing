...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  summaryLabel: { fontSize: 13, fontWeight: '700', color: '#FF3B30', marginBottom: 8 },
  ...
  fieldDesc: { fontSize: 12, color: colors.textSecondary, marginBottom: 8, lineHeight: 18 },
  input: {
  ...
  infoText: { fontSize: 12, color: '#FF9500', flex: 1, lineHeight: 18 },
  errorBox: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
