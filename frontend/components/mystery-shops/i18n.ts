...
const T: Record<Lang, Record<string, string>> = {
  'en-GB': {
    ...
    'rep.intro': "Every shop below was run by our AI {customer}: a phone call to your team member's mobile, a text conversation or an email thread, during your opening hours, captured word for word and graded the same way for everyone. Each one is marked Call, Text shop or Email shop. Tap a shop to hear the call or read the thread and the coaching, or tap a name to see that person's history across months.",
  ...
  en: {
    ...
    'rep.intro': "Every shop below was run by our AI {customer}: a phone call to your team member's cell, a text conversation or an email thread, during your business hours, captured word for word and graded the same way for everyone. Each one is marked Call, Text shop or Email shop. Tap a shop to hear the call or read the thread and the coaching, or tap a name to see that person's history across months.",
    ...
    'sc.thread': 'THE THREAD', 'sc.text_speed': 'Reply speed', 'rep.text_reply': 'First text reply', 'rep.text_noreply': '{n} unanswered', 'rep.texted': 'texted', 'rep.emailed': 'emailed', 'em.badge': 'EMAIL SHOP', 'status.emailing': 'Emailing', 'call.badge': 'PHONE SHOP', 'ch.call': 'Call', 'ch.text': 'Text shop', 'ch.email': 'Email shop', 'rep.all_channels': 'Calls, texts and emails', 'rep.calls': 'Calls', 'rep.texts': 'Texts', 'rep.emails': 'Emails', 'rep.ch_none': 'none yet', 'rep.thread_inside': 'Full thread and coaching inside', 'rep.email_reply': 'First email reply',
    // person sheet
    ...
    // scorecard page
    'sc.kicker': "I'M ON SOCIAL · MYSTERY SHOP SCORECARD", 'sc.invalid': 'This scorecard link is not valid.', 'sc.title': "{name}, here's how that call went", 'sc.title_text': "{name}, here's how that text conversation went", 'sc.title_email': "{name}, here's how that email thread went", 'sc.title_generic': 'Your mystery shop', 'sc.score': 'score',
    'sc.was': 'the {customer} was {name}', 'sc.listen': 'LISTEN BACK', 'sc.nailed': 'WHAT YOU NAILED', 'sc.tough': 'Tough one. The next shop is a clean slate.', 'sc.next': 'WORK ON NEXT', 'sc.must': '  · must-have',
    'sc.nothing_missed': 'Nothing missed on the scorecard. Seriously well done.', 'sc.coaching': 'COACHING',
    'sc.footer': "Graded with the {scorecard} scorecard by I'm On Social. Want to practice this exact scenario any time? Ask your manager about I'm On Social training.", 'sc.phone': 'phone',
  },
  nl: {
    ...
    'rep.intro': 'Elke shop hieronder is door onze AI-{customer} gedaan: een telefoongesprek naar het mobiele nummer van jullie medewerker, een sms-gesprek of een e-mailwisseling, binnen jullie openingstijden, woord voor woord vastgelegd en voor iedereen op dezelfde manier beoordeeld. Elke shop is gemarkeerd als Gesprek, Sms-shop of E-mailshop. Tik op een shop om het gesprek te horen of de berichten en de coaching te lezen, of op een naam voor de historie van die medewerker.',
    ...
    'sc.thread': 'HET GESPREK', 'sc.text_speed': 'Reactiesnelheid', 'rep.text_reply': 'Eerste sms-reactie', 'rep.text_noreply': '{n} onbeantwoord', 'rep.texted': 'ge-sms\'t', 'rep.emailed': 'gemaild', 'em.badge': 'E-MAILSHOP', 'status.emailing': 'E-mailwissel', 'call.badge': 'TELEFOONSHOP', 'ch.call': 'Gesprek', 'ch.text': 'Sms-shop', 'ch.email': 'E-mailshop', 'rep.all_channels': 'Gesprekken, sms en e-mail', 'rep.calls': 'Gesprekken', 'rep.texts': 'Sms', 'rep.emails': 'E-mails', 'rep.ch_none': 'nog geen', 'rep.thread_inside': 'Volledig gesprek en coaching binnenin', 'rep.email_reply': 'Eerste e-mailreactie',
    ...
    'sc.kicker': "I'M ON SOCIAL · MYSTERY SHOP SCOREKAART", 'sc.invalid': 'Deze scorekaart-link is niet geldig.', 'sc.title': '{name}, zo ging dat gesprek', 'sc.title_text': '{name}, zo ging dat sms-gesprek', 'sc.title_email': '{name}, zo ging die e-mailwisseling', 'sc.title_generic': 'Jouw mystery shop', 'sc.score': 'score',
    'sc.was': 'de {customer} was {name}', 'sc.listen': 'LUISTER TERUG', 'sc.nailed': 'WAT JE GOED DEED', 'sc.tough': 'Pittig. De volgende shop begint met een schone lei.', 'sc.next': 'WERK HIERAAN', 'sc.must': '  · must-have',
    'sc.nothing_missed': 'Niets gemist op de scorekaart. Echt goed gedaan.', 'sc.coaching': 'COACHING',
    'sc.footer': "Beoordeeld met de scorekaart {scorecard} door I'm On Social. Wil je dit scenario oefenen wanneer je wilt? Vraag je manager naar I'm On Social training.", 'sc.phone': 'telefoon',
  },
};
