...
const s = StyleSheet.create({
  ...
  pageContext: { fontSize: 13, color: '#8E8E93', marginTop: 1 },
  messagesArea: { flex: 1 },
  messagesContent: { padding: 16, gap: 10 },
  emptyState: { alignItems: 'center', paddingTop: 40, gap: 8 },
  emptyTitle: { fontSize: 18, fontWeight: '600' },
  emptyHint: { fontSize: 15, textAlign: 'center', lineHeight: 20 },
  ...
  speakingText: { fontSize: 13, color: '#C9A962', fontWeight: '500' },
  inputBar: {
    flexDirection: 'row',
    alignItems: 'center',
