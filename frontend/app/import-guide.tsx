...
const styles = StyleSheet.create({
  ...
  subtitle: { textAlign: 'center', color: '#888', fontSize: 15, marginBottom: 40 },
  ...
  formatLabel: { fontSize: 12, color: '#888', marginTop: 4 },
  formatSource: { fontSize: 13, color: '#aaa', marginTop: 8 },
  ...
  stepTitle: { fontSize: 17, fontWeight: '600', color: '#f5f5f5' },
  stepDesc: { color: '#aaa', fontSize: 14, lineHeight: 22, paddingLeft: 44 },
  ...
  calloutText: { fontSize: 14, color: '#8fbc8f', lineHeight: 20 },
  ...
  calloutWarnText: { fontSize: 14, color: '#bcbc8f', lineHeight: 20 },
