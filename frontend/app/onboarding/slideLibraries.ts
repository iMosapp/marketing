...
export const SHARED_SLIDES: OnboardingSlide[] = [
  {
    ...
    subtitle: 'Your Relationship Management System',
...
export const ORG_ADMIN_SLIDES: OnboardingSlide[] = [
  ...
  // Complete
  {
    ...
    description: 'You have full access to manage your organization. Your managers and team are waiting!',
    icon: 'checkmark-done',
    iconColor: '#34C759',
    bgGradient: ['#0F2E1A', '#1A2E1A'],
    benefits: [
      '✅ View organization dashboard',
      '✅ Manage all stores & users',
...
export const STORE_MANAGER_SLIDES: OnboardingSlide[] = [
  ...
  // Complete
  {
    ...
    description: 'You\'re set up to lead your team. Now go help them succeed!',
    icon: 'checkmark-done',
    iconColor: '#34C759',
    bgGradient: ['#0F2E1A', '#1A2E1A'],
    benefits: [
...
export const SALESPERSON_SLIDES: OnboardingSlide[] = [
  ...
  // Salesperson Welcome
  {
    ...
    benefits: [
      ...
      '🤖 AI that responds when you\'re busy',
      '💳 Digital business card to share',
  ...
  // Digital Business Card
  {
    ...
    subtitle: 'Share Your Contact Info Instantly',
    description: 'A sleek, shareable card with your photo, contact info, and QR code.',
    icon: 'card',
    iconColor: '#5856D6',
    bgGradient: ['#1A0F2E', '#2D1B4E'],
    demoComponent: 'DigitalCardDemo',
    benefits: [
      '📱 Share via text, email, or QR',
      '👤 Your photo & contact info',
      '📇 Customers save you to their phone',
      '📍 Find in More → My Account',
    ],
  },
  // Congrats Cards
  {
