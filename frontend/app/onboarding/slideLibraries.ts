...
export const SALESPERSON_SLIDES: OnboardingSlide[] = [
  ...
  // Congrats Cards
  {
    ...
    description: "Send branded cards when your customers buy. They land on a page with your socials, Google reviews, and direct feedback. It feels human.",
    icon: 'gift',
    iconColor: '#FF2D55',
    bgGradient: ['#2E0F1A', '#1A1A1A'],
    ...
    benefits: [
      ...
      'Collects reviews & social engagement',
  ...
  // Complete
  {
    ...
    title: 'You\'re Ready!',
    subtitle: 'Own Your Reputation',
    description: 'You\'ve got everything you need. Time to start building relationships and your social presence!',
    icon: 'checkmark-done',
    iconColor: '#34C759',
    bgGradient: ['#0F2E1A', '#1A2E1A'],
    benefits: [
      'Inbox ready for conversations',
      'AI assistant trained to your style',
