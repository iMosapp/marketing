...
const SLIDES: OnboardingSlide[] = [
  ...
  // ================== AI GREETING SETUP ==================
  {
    ...
    interactiveType: 'choice',
    choices: [
      { id: 'assistant', label: 'As Your Assistant', description: '"Hi! I\'m [Name]\'s assistant..."', icon: 'person-add' },
      { id: 'team', label: 'As Your Team', description: '"Hey! This is [Name]\'s team..."', icon: 'people' },
