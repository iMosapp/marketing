...
const s = StyleSheet.create({
  ...
  subtitle: { fontSize: 17, color: '#6E6E73', textAlign: 'center', lineHeight: 22, maxWidth: 400 },
  ...
  tabText: { fontSize: 16, fontWeight: '600', color: '#6E6E73' },
  ...
  planBadgeText: { fontSize: 13, fontWeight: '700', color: '#007AFF' },
  planName: { fontSize: 21, fontWeight: '700', color: '#1D1D1F', marginBottom: 8 },
  priceRow: { flexDirection: 'row', alignItems: 'flex-end', marginBottom: 4 },
  priceSymbol: { fontSize: 21, fontWeight: '700', color: '#007AFF', marginBottom: 4 },
  priceValue: { fontSize: 44, fontWeight: '900', color: '#1D1D1F', lineHeight: 48 },
  priceUnit: { fontSize: 16, color: '#6E6E73', marginBottom: 8, marginLeft: 4 },
  priceCustom: { fontSize: 32, fontWeight: '800', color: '#007AFF', lineHeight: 48 },
  minUsers: { fontSize: 14, color: '#FF9500', marginBottom: 8 },
  planDesc: { fontSize: 16, color: '#6E6E73', lineHeight: 20, marginBottom: 16 },
  featureList: { gap: 8, marginBottom: 20 },
  featureItem: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  featureText: { fontSize: 15, color: '#3A3A3C' },
  planBtn: {
  ...
  planBtnText: { fontSize: 17, fontWeight: '700', color: '#007AFF' },
  faqSection: { alignItems: 'center', paddingVertical: 40, paddingHorizontal: 20 },
  faqTitle: { fontSize: 21, fontWeight: '700', color: '#1D1D1F', marginBottom: 8 },
  faqDesc: { fontSize: 16, color: '#6E6E73', textAlign: 'center', lineHeight: 20 },
});
