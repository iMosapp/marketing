...
const styles = StyleSheet.create({
  ...
  slideNum: { color: '#AEAEB2', fontSize: 15, fontWeight: '500', minWidth: 36, textAlign: 'right' },
  ...
  subtitle: { fontSize: 18, fontWeight: '600', textAlign: 'center', marginBottom: 24 },
  ...
  statLabel: { fontSize: 16, color: '#6E6E73', marginTop: 4, textAlign: 'center' },
  contentLine: { fontSize: 18, color: '#3A3A3C', textAlign: 'center', lineHeight: 26, marginBottom: 12, maxWidth: 480 },
  ...
  featureText: { fontSize: 17, color: '#1D1D1F', fontWeight: '600' },
  featureDesc: { fontSize: 15, color: '#6E6E73', marginTop: 2 },
  ...
  ctaButtonText: { fontSize: 18, fontWeight: '700', color: '#FFF' },
  ctaSecondary: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  ctaSecondaryText: { fontSize: 17, color: '#007AFF', fontWeight: '600' },
  ...
  keyHint: { position: 'absolute', bottom: 6, left: 0, right: 0, textAlign: 'center', fontSize: 13, color: '#D1D1D6' },
});
