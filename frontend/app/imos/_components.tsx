      ...
      <View style={[styles.footerInner, isDesktop && { maxWidth: 1100, flexDirection: 'row', justifyContent: 'space-between' }]}>
        ...
        <View style={[styles.footerLinks, isDesktop && { flexDirection: 'row', gap: 48 }]}>
          <View style={styles.footerCol}>
            ...
            <TouchableOpacity onPress={() => navigate('/imos/hub')}><Text style={styles.footerLink}>All Pages</Text></TouchableOpacity>
          </View>
          <View style={styles.footerCol}>
          ...
          <View style={styles.footerCol}>
            ...
            <TouchableOpacity onPress={() => navigate('/auth/signup')}><Text style={styles.footerLink}>Sign Up</Text></TouchableOpacity>
            <TouchableOpacity onPress={() => navigate('/auth/login')}><Text style={styles.footerLink}>Log In</Text></TouchableOpacity>
          </View>
        </View>
      </View>
