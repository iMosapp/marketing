...
const h = StyleSheet.create({
  ...
  navLink: { fontSize: 16, fontWeight: '500', color: '#555' },
  ...
  demoBtnText: { fontSize: 16, fontWeight: '600', color: '#FFF' },
  hamburger: { padding: 4 },
  ...
  mobileItemText: { fontSize: 18, fontWeight: '500', color: '#1D1D1F' },
  mobileCta: { backgroundColor: '#007AFF', borderRadius: 14, alignItems: 'center', marginTop: 12, paddingVertical: 14 },
  mobileCtaText: { fontSize: 18, fontWeight: '700', color: '#FFF' },
});
...
const dd = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.2, color: '#888', paddingHorizontal: 14, paddingTop: 10, paddingBottom: 4 },
  ...
  desc: { fontSize: 14, color: '#888', lineHeight: 16 },
});
...
const f = StyleSheet.create({
  ...
  tagline: { fontSize: 16, color: '#555', lineHeight: 20, marginBottom: 4 },
  sub: { fontSize: 16, color: '#888', lineHeight: 20 },
  links: { gap: 24, marginBottom: 32 },
  col: { gap: 10 },
  colTitle: { fontSize: 14, fontWeight: '700', color: '#111', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
  link: { fontSize: 16, color: '#888' },
  bottom: { borderTopWidth: 1, borderTopColor: 'rgba(0,0,0,0.06)', paddingVertical: 20, alignItems: 'center' },
  copy: { fontSize: 14, color: '#888' },
});
