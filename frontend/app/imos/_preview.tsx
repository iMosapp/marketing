      ...
      <View style={mp.content}>
        {config.type === 'list' && config.rows.map((r, i) => (
          <View key={i} style={mp.listRow}>
            <View style={[mp.listIcon, { backgroundColor: 'rgba(0,122,255,0.08)' }]}>
...
const s = StyleSheet.create({
  ...
  label: { fontSize: 13, fontWeight: '700', color: '#007AFF', letterSpacing: 2, marginBottom: 10 },
  title: { fontSize: 30, fontWeight: '800', color: '#1D1D1F', textAlign: 'center', marginBottom: 12, lineHeight: 38 },
  desc: { fontSize: 17, color: '#6E6E73', textAlign: 'center', lineHeight: 22, maxWidth: 460 },
  mainContent: { paddingHorizontal: 20, paddingBottom: 40 },
  mockupWrap: { alignItems: 'center', marginBottom: 32 },
  infoSide: {},
  whatTitle: { fontSize: 19, fontWeight: '700', color: '#1D1D1F', marginBottom: 16 },
  bulletRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, marginBottom: 12 },
  bulletText: { fontSize: 17, color: '#3A3A3C', lineHeight: 22, flex: 1 },
  ctaBox: { marginTop: 28, backgroundColor: 'rgba(0,122,255,0.04)', borderRadius: 16, padding: 24, borderWidth: 1, borderColor: 'rgba(0,122,255,0.08)' },
  ctaTitle: { fontSize: 19, fontWeight: '700', color: '#1D1D1F', marginBottom: 6 },
  ctaSub: { fontSize: 16, color: '#86868B', marginBottom: 20 },
  ...
  ctaSecondaryText: { fontSize: 16, color: '#007AFF', fontWeight: '500' },
});
...
const mp = StyleSheet.create({
  phone: {
    ...
    overflow: 'hidden',
    ...(Platform.OS === 'web' ? { boxShadow: '0 8px 32px rgba(0,0,0,0.1)' } as any : {}),
  },
  statusBar: { height: 28, backgroundColor: '#F8F9FB', alignItems: 'center', justifyContent: 'flex-end', paddingBottom: 4 },
  notch: { width: 80, height: 4, borderRadius: 2, backgroundColor: 'rgba(0,0,0,0.06)' },
  appHeader: { paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.06)' },
  appTitle: { fontSize: 18, fontWeight: '600', color: '#1D1D1F' },
  content: { padding: 12, minHeight: 260 },
  listRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.06)' },
  listIcon: { width: 32, height: 32, borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginRight: 10 },
  listLabel: { fontSize: 16, fontWeight: '500', color: '#1D1D1F' },
  listSub: { fontSize: 13, color: '#666', marginTop: 2 },
  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  badgeText: { fontSize: 12, fontWeight: '600' },
  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  statCard: { width: '47%', backgroundColor: '#F5F5F7', borderRadius: 12, padding: 14, alignItems: 'center' },
  ...
  chatThem: { backgroundColor: '#F5F5F7', alignSelf: 'flex-start', borderBottomLeftRadius: 4 },
  chatText: { fontSize: 15, color: '#1D1D1F' },
  chatTime: { fontSize: 9, color: '#AEAEB2', marginTop: 4, textAlign: 'right' },
  cardsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  card: { width: '47%', backgroundColor: '#F5F5F7', borderRadius: 12, padding: 12 },
  ...
  formLabel: { fontSize: 13, color: '#666', marginBottom: 4 },
  formInput: { backgroundColor: '#F5F5F7', borderRadius: 8, padding: 10, borderWidth: 1, borderColor: 'rgba(0,0,0,0.12)' },
  formValue: { fontSize: 15, color: '#999' },
});
