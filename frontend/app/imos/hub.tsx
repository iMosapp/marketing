...
const s = StyleSheet.create({
  ...
  subtitle: { fontSize: 17, color: '#8E8E93', textAlign: 'center', lineHeight: 22, maxWidth: 400 },
  ...
  sectionTitle: { fontSize: 18, fontWeight: '600', color: '#1D1D1F' },
  ...
  pageTitle: { fontSize: 17, fontWeight: '600', color: '#1D1D1F' },
  ...
  pageUrl: { fontSize: 12, color: '#4A4A4C', marginTop: 3, fontFamily: Platform.OS === 'web' ? 'monospace' : undefined },
