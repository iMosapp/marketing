...
const PAGE_CATALOG: Category[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { name: 'Phone Numbers', description: 'Buy, assign and pool Twilio numbers', path: '/imos/phone-assignments', icon: 'call-outline', color: '#32ADE6', audience: 'Super Admin' },
...
export default function AppDirectoryScreen() {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      if (res.data.success) {
        showAlert('Sent!', `${shareChannel === 'email' ? 'Email' : 'SMS'} sent successfully`);
        closeShareModal();
      }
    } catch (err: any) {
...
const st = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: 17, color: '#1D1D1F' },
  ...
  catTitle: { fontSize: 18, fontWeight: '600', color: '#1D1D1F', flex: 1 },
  ...
  pageInfo: { flex: 1 },
  pageName: { fontSize: 17, fontWeight: '600', color: '#1D1D1F' },
  pageDesc: { fontSize: 14, color: '#8E8E93', marginTop: 2 },
  pageUrl: { fontSize: 12, color: '#4A4A4C', fontFamily: Platform.OS === 'web' ? 'monospace' : undefined, marginBottom: 2 },
  pageAudience: { fontSize: 13, color: '#5856D6', marginBottom: 8 },
  ...
  actionText: { fontSize: 14, fontWeight: '500', color: '#1D1D1F' },
  emptyState: { alignItems: 'center', paddingVertical: 60 },
  emptyText: { color: '#8E8E93', fontSize: 18, marginTop: 12 },
  ...
  modalSend: { fontSize: 18, fontWeight: '600', color: '#007AFF' },
  ...
  sharePageName: { fontSize: 18, fontWeight: '600', color: '#1D1D1F' },
  sharePagePath: { fontSize: 14, color: '#6E6E73', marginTop: 4 },
  inputLabel: { fontSize: 15, fontWeight: '600', color: '#8E8E93', marginBottom: 8, marginTop: 16, marginLeft: 4 },
  modalInput: { backgroundColor: '#F5F5F7', borderRadius: 10, padding: 14, fontSize: 17, color: '#1D1D1F', borderWidth: 1, borderColor: 'rgba(0,0,0,0.06)' },
  ...
  channelText: { fontSize: 17, fontWeight: '500', color: '#8E8E93' },
