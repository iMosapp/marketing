...
const TAG_ICONS = [
  ...
  { id: "diamond", name: "Premium" },
  { id: "gift", name: "Gift" },
  { id: "rocket", name: "Rocket" },
  { id: "flag", name: "Flag" },
  { id: "thumbs-up", name: "Thumbs Up" },
  { id: "thumbs-down", name: "Thumbs Down" },
  { id: "people", name: "People" },
  { id: "home", name: "Home" },
  { id: "briefcase", name: "Business" },
  { id: "call", name: "Phone" },
  { id: "mail", name: "Email" },
  { id: "chatbubble", name: "Chat" },
  { id: "location", name: "Location" },
  { id: "calendar", name: "Calendar" },
  { id: "trending-up", name: "Growth" },
  { id: "trending-down", name: "Decline" },
  { id: "shield-checkmark", name: "Verified" },
  { id: "lock-closed", name: "Locked" },
  { id: "eye", name: "Viewed" },
  { id: "happy", name: "Happy" },
  { id: "sad", name: "Sad" },
  { id: "snow", name: "Winter" },
  { id: "sunny", name: "Summer" },
  { id: "leaf", name: "Organic" },
  { id: "flash", name: "Urgent" },
  { id: "megaphone", name: "Announce" },
  { id: "ribbon", name: "Ribbon" },
  { id: "fitness", name: "Fitness" },
  { id: "medkit", name: "Medical" },
  { id: "school", name: "Education" },
  { id: "airplane", name: "Travel" },
  { id: "restaurant", name: "Food" },
  { id: "musical-notes", name: "Music" },
  { id: "football", name: "Sports" },
  { id: "paw", name: "Pet" },
  { id: "bulb", name: "Idea" },
  { id: "cart", name: "Shopping" },
  { id: "card", name: "Credit" },
  { id: "key", name: "Key" },
  { id: "link", name: "Link" },
  { id: "hand-left", name: "Wave" },
  { id: "sparkles", name: "AI" },
  { id: "color-palette", name: "Creative" },
  { id: "hammer", name: "Build" },
  { id: "wine", name: "Wine" },
  { id: "earth", name: "Global" },
];
