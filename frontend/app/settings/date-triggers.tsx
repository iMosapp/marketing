...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  tabText: { fontSize: 17, fontWeight: '600', color: colors.textSecondary },
  ...
  triggerTitle: { fontSize: 18, fontWeight: '600', color: colors.text },
  ...
  fieldHint: { fontSize: 14, color: '#6E6E73', marginBottom: 8 },
  ...
  templateInput: {
    ...
    color: colors.text, fontSize: 17, minHeight: 80, textAlignVertical: 'top',
  },
  saveBtn: {
    backgroundColor: '#C9A962', paddingVertical: 14, borderRadius: 20,
    alignItems: 'center', marginTop: 16,
  },
  saveBtnText: { color: colors.text, fontSize: 17, fontWeight: '600' },
  holidayRow: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: colors.surface,
  },
  holidayName: { flex: 1, fontSize: 17, color: colors.text },
