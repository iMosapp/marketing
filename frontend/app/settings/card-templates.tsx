...
const getS = (colors: any) => StyleSheet.create({
  ...
  cardSub: { fontSize: 15, color: '#8E8E93', marginTop: 2 },
  label: { fontSize: 12, fontWeight: '700', color: '#6E6E73', marginTop: 16, marginBottom: 6, letterSpacing: 1 },
  hint: { fontSize: 13, color: '#8E8E93', marginBottom: 6 },
  ...
  previewMsg: { fontSize: 16, color: '#FFFFFFCC', textAlign: 'center', lineHeight: 20 },
  previewFooter: { fontSize: 13, color: '#8E8E93', marginTop: 12 },
