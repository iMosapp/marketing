...
const getS = (colors: any) => StyleSheet.create({
  ...
  createBtnText: { fontSize: 17, fontWeight: '700', color: colors.text },
  ...
  recipientInput: { backgroundColor: colors.card, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 12, fontSize: 14, color: colors.text, borderWidth: 1.5, borderColor: colors.borderLight },
  ...
  shareOptionText: { fontSize: 12, fontWeight: '500', color: colors.text, textAlign: 'center' },
  ...
  previewSalesName: { fontSize: 16, fontWeight: '700', color: colors.text, marginBottom: 2 },
  ...
  modalBoxName: { fontSize: 17, fontWeight: '600', color: colors.text },
  ...
  modalActionText: { fontSize: 15, color: colors.text, fontWeight: '500', flex: 1 },
});
