...
const getS = (colors: any) => StyleSheet.create({
  ...
  createBtnText: { fontSize: 17, fontWeight: '700', color: colors.card },
  ...
  shareTitle: { fontSize: 20, fontWeight: '700', color: colors.card, textAlign: 'center', marginBottom: 4 },
  ...
  recipientInput: { backgroundColor: colors.card, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 12, fontSize: 14, color: colors.card, borderWidth: 1.5, borderColor: colors.borderLight },
  ...
  shareOptionText: { fontSize: 12, fontWeight: '500', color: colors.card, textAlign: 'center' },
  ...
  previewName: { fontSize: 24, fontWeight: '700', color: colors.card, marginBottom: 12, textAlign: 'center' },
  ...
  previewSalesName: { fontSize: 16, fontWeight: '700', color: colors.card, marginBottom: 2 },
  ...
  previewSendText: { fontSize: 16, fontWeight: '700', color: colors.card },
  // Match modal
  ...
  modalTitle: { fontSize: 18, fontWeight: '700', color: colors.card, textAlign: 'center', marginBottom: 8 },
  ...
  modalBoxName: { fontSize: 17, fontWeight: '600', color: colors.card },
  ...
  modalActionText: { fontSize: 15, color: colors.card, fontWeight: '500', flex: 1 },
});
