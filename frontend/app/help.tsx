...
const HELP_ARTICLES: HelpArticle[] = [
  {
    ...
    steps: [
      ...
      'Your new logo will automatically update on Digital Business Cards, Review Pages, Emails, The Showcase, and Congrats Cards',
    ],
  ...
  },
  {
    id: 'share-showroom',
    icon: 'images-outline',
    title: 'How to Share Your Showcase',
    category: 'Social Proof',
    steps: [
      'Go to Home > "My Showcase" tile',
      'Tap to share your public Showcase URL via link, text, or email',
      'Share this link on social media, in your email signature, or on business cards',
      'Your Showcase automatically displays your delivery photos and customer reviews',
    ],
    tip: 'You can also view your Showcase by tapping "Preview" in the share modal.',
    navPath: '/showcase',
  },
  {
    id: 'leaderboard',
