      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <View style={styles.optionsContainer}>
          ...
          >
            ...
            <Text style={{ fontSize: 17, color: '#007AFF', fontWeight: '600' }}>How to Export Your Contacts (Step-by-Step Guide)</Text>
          </TouchableOpacity>
        </View>
        {loading && (
...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  importButtonText: { fontSize: 18, fontWeight: '600', color: '#007AFF' },
  importButtonDisabled: { color: colors.borderLight },
  optionsContainer: { padding: 20 },
  optionsTitle: { fontSize: 17, color: colors.textSecondary, marginBottom: 20, textAlign: 'center' },
  ...
  optionDesc: { fontSize: 16, color: colors.textSecondary },
  ...
  csvHintText: { flex: 1, fontSize: 15, color: colors.textSecondary, lineHeight: 18 },
  loadingOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.8)', justifyContent: 'center', alignItems: 'center' },
  loadingText: { marginTop: 16, fontSize: 18, color: colors.text },
  ...
  statNum: { fontSize: 21, fontWeight: '700', color: colors.text },
  ...
  selectAllText: { fontSize: 17, color: colors.text, fontWeight: '500' },
  selectedCount: { fontSize: 16, color: colors.textSecondary },
  ...
  contactInfo: { flex: 1 },
  contactName: { fontSize: 18, fontWeight: '600', color: colors.text },
  contactOrg: { fontSize: 15, color: colors.textSecondary, marginTop: 1 },
  contactPhone: { fontSize: 16, color: colors.textSecondary, marginTop: 3 },
  contactEmail: { fontSize: 15, color: colors.textSecondary, marginTop: 1 },
  contactExtra: { fontSize: 14, color: colors.textTertiary, marginTop: 1 },
  dupBadge: { backgroundColor: '#FF950030', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  dupBadgeText: { fontSize: 12, fontWeight: '700', color: '#FF9500' },
  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 64 },
  emptyText: { fontSize: 19, color: colors.textSecondary, marginTop: 16 },
  ...
  importActionText: { fontSize: 18, fontWeight: '600', color: '#fff' },
});
