...
const styles = StyleSheet.create({
  ...
  teamAvatar: { width: 56, height: 56, borderRadius: 28, borderWidth: 2, borderColor: '#C9A962' },
  teamAvatarPlaceholder: { width: 56, height: 56, borderRadius: 28, backgroundColor: '#1C1C1E', alignItems: 'center', justifyContent: 'center' },
