...
const styles = StyleSheet.create({
  ...
  errorText: { color: '#8E8E93', fontSize: 18, marginTop: 12 },
  scrollContent: {
    paddingBottom: 40,
  ...
  tagline: { fontSize: 16, color: '#C9A962', marginTop: 4, fontWeight: '500' },
  ...
  actionLabel: { fontSize: 13, color: '#8E8E93', fontWeight: '500' },
  section: { paddingHorizontal: 24, marginTop: 24 },
  sectionTitle: { fontSize: 15, fontWeight: '600', color: '#C9A962', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 14 },
  infoRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#1A1A1A' },
  infoText: { fontSize: 17, color: '#CCC', flex: 1 },
  ...
  teamAvatarText: { color: '#C9A962', fontSize: 18, fontWeight: '600' },
  teamName: { fontSize: 14, color: '#FFF', fontWeight: '600', marginTop: 6, textAlign: 'center' },
  teamTitle: { fontSize: 12, color: '#8E8E93', textAlign: 'center', marginTop: 1 },
  ...
  testimonialText: { fontSize: 16, color: '#CCC', fontStyle: 'italic', lineHeight: 20, marginBottom: 8 },
  testimonialAuthor: { fontSize: 14, color: '#8E8E93' },
  feedbackCard: { backgroundColor: '#1A1A1C', borderRadius: 12, padding: 20, borderWidth: 1, borderColor: '#2A2A2C' },
  feedbackLabel: { fontSize: 17, color: '#CCC', textAlign: 'center', marginBottom: 14 },
  ...
  successTitle: { fontSize: 19, fontWeight: '700', color: '#FFF', marginTop: 10 },
  successText: { fontSize: 16, color: '#8E8E93', marginTop: 4 },
  input: { backgroundColor: '#111', borderRadius: 10, padding: 14, fontSize: 17, color: '#FFF', borderWidth: 1, borderColor: '#2A2A2C', marginBottom: 10 },
  ...
  footerBrand: { fontSize: 14, fontWeight: '700', color: '#8E8E93' },
});
