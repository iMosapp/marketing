...
const s = StyleSheet.create({
  ...
  pinSubtitle: { fontSize: 14, color: '#999', textAlign: 'center', marginBottom: 24, maxWidth: 280 },
  pinInput: { width: 200, height: 50, backgroundColor: '#1C1C1E', borderRadius: 12, color: '#FFFFFF', fontSize: 20, textAlign: 'center', letterSpacing: 8, borderWidth: 1, borderColor: '#333', marginBottom: 12 },
  pinError: { color: '#FF3B30', fontSize: 13, marginBottom: 8 },
  pinButton: { backgroundColor: '#C9A962', paddingHorizontal: 40, paddingVertical: 14, borderRadius: 12, marginTop: 8 },
  pinButtonText: { color: '#000', fontSize: 16, fontWeight: '700' },
  // Header
  header: { paddingVertical: 20, paddingHorizontal: 20, alignItems: 'center', gap: 8 },
  storeLogo: { width: 140, height: 50 },
  storeName: { fontSize: 16, fontWeight: '700', color: '#FFFFFF', letterSpacing: 1 },
  // Contact card
  ...
  contactInitials: { fontSize: 20, fontWeight: '800' },
  contactInfo: { flex: 1 },
  contactName: { fontSize: 20, fontWeight: '800', color: '#FFFFFF' },
  contactDetail: { fontSize: 13, color: '#8E8E93', marginTop: 2 },
  spRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#2C2C2E' },
  spText: { fontSize: 13, color: '#8E8E93' },
  ...
  sectionTitle: { fontSize: 16, fontWeight: '700', color: '#FFFFFF', marginBottom: 12, letterSpacing: 0.5 },
  // Day group
  dayGroup: { marginBottom: 16 },
  dayLabel: { fontSize: 12, fontWeight: '700', color: '#C9A962', marginBottom: 8, letterSpacing: 1, textTransform: 'uppercase' },
  // Event row
  ...
  noteText: { fontSize: 14, color: '#FFFFFF', lineHeight: 20 },
  noteDate: { fontSize: 11, color: '#666', marginTop: 6 },
  // Footer
  footer: { alignItems: 'center', paddingVertical: 32, gap: 4 },
  footerText: { fontSize: 13, color: '#444', fontWeight: '600' },
