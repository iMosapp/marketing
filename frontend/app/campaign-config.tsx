...
const st = StyleSheet.create({
  ...
  levelLabel: { color: '#8E8E93', fontSize: 15 },
  ...
  levelBtnText: { color: '#666', fontSize: 14, fontWeight: '600' },
  levelBtnTextActive: { color: '#FFF' },
  section: { marginHorizontal: 16, marginBottom: 20 },
  sectionTitle: { color: '#FFF', fontSize: 18, fontWeight: '700', marginBottom: 2 },
  sectionSubtitle: { color: '#8E8E93', fontSize: 14, marginBottom: 12 },
  ...
  optionTitle: { color: '#CCC', fontSize: 16, fontWeight: '600' },
  optionTitleActive: { color: '#FFF' },
  optionDesc: { color: '#666', fontSize: 14, lineHeight: 16, marginTop: 2 },
  ...
  toggleDesc: { color: '#666', fontSize: 13, lineHeight: 15, marginTop: 2 },
});
