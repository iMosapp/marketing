...
import { buildStamp, installedVersion } from '../../utils/buildStamp';
        ...
        <View style={styles.versionContainer}>
          {partnerBranding ? (
            ...
            <>
              ...
              <Text style={[styles.version, { marginTop: 4 }]} testID="installed-version" dataSet={{ testid: 'installed-version' } as any}>{installedVersion()}</Text>
