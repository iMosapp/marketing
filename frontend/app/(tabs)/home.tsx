...
function HomeScreen() {
  ...
  const TILES = [
    { key: 'sold',        icon: 'trophy',     label: 'SOLD!',       sublabel: 'Snap the moment & start campaign', color: '#C9A962', onPress: () => router.push('/settings/create-card?type=congrats&sold_flow=true' as any) },
