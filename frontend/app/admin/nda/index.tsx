...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  emptySub: { fontSize: 16, color: colors.textSecondary, marginTop: 8 },
  ...
  createBtnText: { fontSize: 18, fontWeight: '600', color: colors.text },
  card: { backgroundColor: colors.card, borderRadius: 16, padding: 16, marginBottom: 12 },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 },
  recipientName: { fontSize: 18, fontWeight: '600', color: colors.text },
  recipientEmail: { fontSize: 16, color: colors.textSecondary, marginTop: 2 },
