...
const s = StyleSheet.create({
  ...
  summaryLabel: { color: '#888', fontSize: 10, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.3 },
  ...
  sectionHint: { color: '#FF9500', fontSize: 12, fontWeight: '500', marginBottom: 10, fontStyle: 'italic' },
  ...
  repName: { color: '#C9A962', fontSize: 11, fontWeight: '500' },
  leadTime: { color: '#555', fontSize: 11, marginLeft: 4 },
  ...
  repInitial: { color: '#FFF', fontSize: 18, fontWeight: '700' },
  repCardName: { color: '#FFF', fontSize: 15, fontWeight: '600', marginBottom: 4 },
  statsRow: { flexDirection: 'row', gap: 12 },
  stat: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  statNum: { color: '#AAA', fontSize: 12, fontWeight: '600' },
  repRight: { alignItems: 'center' },
  repTotal: { color: '#FFF', fontSize: 18, fontWeight: '700' },
  repTotalLabel: { color: '#666', fontSize: 10, textTransform: 'uppercase' },
  ...
  signalBubbleText: { color: '#007AFF', fontSize: 10, fontWeight: '700' },
  ...
  reassignBannerText: { color: '#C9A962', fontSize: 14, fontWeight: '500', flex: 1 },
  searchRow: {
  ...
  searchInput: { flex: 1, fontSize: 15, color: '#FFF', padding: 4 },
  userRow: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#1C1C1E',
  ...
  userInitial: { color: '#FFF', fontSize: 16, fontWeight: '700' },
