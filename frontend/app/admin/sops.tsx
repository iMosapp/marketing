...
const s = StyleSheet.create({
  ...
  requiredText: { fontSize: 13, fontWeight: '600', color: '#FF3B30' },
  diffBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4 },
  diffText: { fontSize: 13, fontWeight: '600', textTransform: 'capitalize' as any },
  timeText: { fontSize: 14 },
  sopTitle: { fontSize: 18, fontWeight: '600', marginBottom: 4 },
  sopSummary: { fontSize: 16, lineHeight: 20 },
  stepsSection: { marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: 'rgba(128,128,128,0.15)' },
  stepsTitle: { fontSize: 16, fontWeight: '600', marginBottom: 10 },
  ...
  stepNumText: { fontSize: 15, fontWeight: '700' },
  stepContent: { flex: 1 },
  stepTitle: { fontSize: 16, fontWeight: '600', marginBottom: 2 },
  stepDesc: { fontSize: 15, lineHeight: 18 },
