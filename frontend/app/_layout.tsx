...
export default function RootLayout() {
  ...
  const publicRoutes = ['auth', 'index', 'onboarding', 'p', 'card', 'proof', 'congrats', 'opt-in', 'review', 'showcase', 'l', 'birthday', 'timeline', 'imos', 'import-guide', 'cs-login', 'proposal', 'shop-report'];
