...
const styles = StyleSheet.create({
  ...
  factorIcon: { width: 36, height: 36, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginRight: 12, flexShrink: 0 },
  factorInfo: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', minWidth: 0 },
  factorLabel: { fontSize: 14, fontWeight: '600', flex: 1, marginRight: 8 },
  factorScore: { fontSize: 14, fontWeight: '700', flexShrink: 0 },
