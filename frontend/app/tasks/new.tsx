...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  saveButtonText: { fontSize: 17, fontWeight: '600', color: '#007AFF' },
  ...
  voiceBtnHint: { fontSize: 12, marginTop: 2 },
  ...
  recordingText: { fontSize: 16, fontWeight: '600', color: '#FF3B30' },
  recordingHint: { fontSize: 12, marginTop: 4 },
  ...
  voiceProcessingText: { fontSize: 14, fontWeight: '500' },
  ...
  typeName: { fontSize: 13, fontWeight: '600', color: colors.textSecondary, marginTop: 6 },

  // Inputs
  input: { backgroundColor: colors.card, borderRadius: 12, padding: 16, fontSize: 16, color: colors.text, borderWidth: 1, borderColor: colors.surface },
  textArea: { backgroundColor: colors.card, borderRadius: 12, padding: 16, fontSize: 16, color: colors.text, borderWidth: 1, borderColor: colors.surface, height: 100 },
  ...
  selectButtonText: { flex: 1, fontSize: 16, color: colors.text },

  // Date
  dateButton: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  dateText: { fontSize: 16, color: colors.text },
  timeInputInline: { fontSize: 16, fontWeight: '600', textAlign: 'right', width: 60 },
  ...
  searchInput: { borderRadius: 10, padding: 12, fontSize: 16, borderWidth: 1, marginBottom: 12 },
  contactList: { flex: 1 },
  ...
  contactAvatarText: { color: '#FFF', fontSize: 14, fontWeight: '700' },
  contactName: { fontSize: 15, fontWeight: '600' },
  contactDetail: { fontSize: 12, marginTop: 1 },
