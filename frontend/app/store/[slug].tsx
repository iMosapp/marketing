...
const styles = StyleSheet.create({
  ...
  errorText: { color: '#999', fontSize: 18 },
  ...
  orgName: { fontSize: 16, color: '#999', marginTop: 4 },
  locationRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 8 },
  locationText: { fontSize: 16, color: '#999' },
  addressText: { fontSize: 15, color: '#666', marginTop: 4 },
  ...
  contactBtnText: { fontSize: 16, fontWeight: '500', color: '#007AFF' },
  teamSection: { paddingHorizontal: 16, paddingTop: 24 },
  teamTitle: { fontSize: 21, fontWeight: '600', color: '#FFF', marginBottom: 16 },
  memberCard: {
  ...
  memberInitials: { fontSize: 19, fontWeight: '600', color: '#555' },
  memberInfo: { flex: 1 },
  memberName: { fontSize: 18, fontWeight: '600', color: '#FFF' },
  memberTitle: { fontSize: 15, color: '#999', marginTop: 2 },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 4 },
  stars: { flexDirection: 'row', gap: 1 },
  ratingText: { fontSize: 14, color: '#999' },
  memberBio: { fontSize: 15, color: '#666', marginTop: 4, lineHeight: 18 },
  emptyText: { fontSize: 16, color: '#555', textAlign: 'center', paddingVertical: 40 },
